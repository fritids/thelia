...
<form action="<?php echo($_SERVER['PHP_SELF']); ?>" method="post" ENCTYPE="multipart/form-data">
    ...
    <td colspan="2" height="1" class="fond_CDCDCD"></td>
	 ...
	 <tr>
     <td  width="20%" align="left" valign="middle" class="arial11_bold_626262"><img src="../fonctions/redimlive.php?nomorig=../client/gfx/photos/contenu/<?php echo($row->fichier); ?>&width=&height=200&opacite=&nb=" border="0" / ></td>
      <td width="20%">
