  ...
  <table width="100%"  border="0" cellpadding="0" cellspacing="2" class="fond_F0F0F0">
	 ...
	 <tr>
      <td  width="40%" align="left" valign="middle" class="arial11_bold_626262"><?php echo($dossierdesc->titre); ?> / <?php echo($contenudesc->titre); ?></td>
       <td width="20%" align="left" valign="middle" class="arial11_bold_626262"><a href="<?php echo($_SERVER['PHP_SELF']); ?>?action=supprimer&id=<?php echo($row->id); ?>&objet=<?php echo($objet); ?>&type=<?php echo($type); ?>">Supprimer</a></td>
     ...
     <tr>
        ...
        ?>
        	 <tr>
				...
				<td width="40%"><a href="<?php echo($_SERVER['PHP_SELF']); ?>?action=ajouter&objet=<?php echo($objet); ?>&type=<?php echo($type); ?>&contenu=<?php echo($row->id); ?>">Activer</a></td>     		
 	<tr>
    <td colspan="3" height="1" class="fond_CDCDCD"></td>
    </tr>       	
