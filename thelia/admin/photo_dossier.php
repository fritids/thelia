...
<?php
	...
	function ajouter($id){
		...
		if($photo != ""){
			...
			copy("$photo", "../client/gfx/photos/dossier/grande/" . $fich . "_" . $lastid . "." . $extension);
	   		copy("$photo", "../client/gfx/photos/dossier/petite/" . $fich . "_" . $lastid . "." . $extension);
    		resize("../client/gfx/photos/dossier/petite/" . $fich . "_" . $lastid . "." . $extension, $photoprodw->valeur);
