...
<?php
	...
	class Commande extends Baseobj{
		...
		var $lang;
		var $table="commande";
		var $bddvars = array("id", "client", "adrfact", "adrlivr", "date", "datefact", "ref", "transaction", "livraison", "facture", "transport", "port", "datelivraison", "remise", "colis", "paiement", "statut", "lang");
