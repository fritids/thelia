...
<?php
	...
	class Bluepaid extends PluginsPaiements{
		...
		function init(){
			...
			$cnx = new Cnx();
			$query_bluepaid = "CREATE TABLE `bluepaid_pays` (
			...
			$resul_commentaires = mysql_query($query_bluepaid, $cnx->link);	
			
			$query_bluepaid = "INSERT INTO `bluepaid_pays` (`id`, `pays`, `alpha3`, `alpha2`, `code`) VALUES 
			(1, 1, 'AFG', 'AF', '004'),
			(2, 2, 'ZAF', 'ZA', '710'),
			(3, 3, 'ALB', 'AL', '008'),
			(4, 4, 'DZA', 'DZ', '012'),
