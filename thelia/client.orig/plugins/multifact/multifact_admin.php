...
<script type="text/javascript">
	...
	<div id="contenu_int"> 
	   <p class="titre_rubrique">Facture multiples</p>
	     <p align="right" class="geneva11Reg_3B4B5B"><a href="accueil.php" class="lien04">Accueil </a> <img src="gfx/suivant.gif" width="12" height="9" border="0" /><a href="#" class="lien04">Facture multiples</a>              
	    </p>
	     <table width="710" border="0" cellpadding="5" cellspacing="0">
	     <tr>
	       <td width="600" height="30" class="titre_cellule_tres_sombre">Liste des commandes payés non traitées</td>
	     </tr>
	   </table>
<form action="../client/plugins/multifact/export.php" id="formexport" method="post">
<input type="hidden" name="nom" value="multifact" />
...
<a href="javascript:document.getElementById('formexport').submit()" class="lien04">Générer les factures</a>
